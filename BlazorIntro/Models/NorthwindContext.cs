...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<CustomersFromStockholm> CustomersFromStockholms { get; set; }

    public virtual DbSet<Employee> Employees { get; set; }

    public virtual DbSet<EmployeeNameAndTitle> EmployeeNameAndTitles { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomersFromStockholm>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomersFromStockholm");
        ...
        modelBuilder.Entity<EmployeeNameAndTitle>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("EmployeeNameAndTitle");
